...
use Mysic\LaravelAdminApization\Show;
use Mysic\LaravelAdminApization\Form;
use Illuminate\Support\Str;

//todo Grid Show Form 全部修改为依赖注入的方式
class PermissionController extends UsersBaseController
{
    /**
     * {@inheritdoc}
     */
